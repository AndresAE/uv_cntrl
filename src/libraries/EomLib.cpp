/*
  EomLib.h - Equations of Motion Library for Control Systems - implementation
...
// Public Methods //////////////////////////////////////////////////////////////
// local acceleration
float EomLib::pid(float setpoint, float process_variable, float d_t, float k_p, float k_i, float k_d)
{
